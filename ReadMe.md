...
Note that step02a & step02b requires ``scene_graph.pkl`` and step03 requires ``process_based_task.pkl``, which means you have to run former scripts before the latter scripts in order to avoid errors.
...
### Online testing (Benchmark Results)
